    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" style={{ background: '#1b1b1f' }}>      
      <div className="max-w-sm w-full relative z-10 animate-fade-up">
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl font-bold text-[#f3f3f3] tracking-tight">Welcome back</h2>
          <p className="text-[#9d9d9d] text-[14px] mt-1">Sign in to your DataFlow workspace.</p>
        </div>
        ...
        <div className="rounded-lg p-6" style={{ background: '#252529', border: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                <label className="text-[13px] font-medium text-[#cccccc]">Password</label>
                <a href="#" className="text-[11px] font-medium text-[#0078D4] hover:text-[#2b88d8]">Forgot?</a>
              </div>
          ...
          <div className="mt-4 text-center text-[13px] text-[#9d9d9d] border-t border-white/[0.06] pt-4">
            ...
            <a href="/register" className="text-[#0078D4] hover:text-[#2b88d8] font-semibold transition-colors">Create one</a>
          </div>
        </div>
      </div>
    </div>
